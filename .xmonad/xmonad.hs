...
import qualified XMonad.Layout.Fullscreen      as W
...
myKeys conf@XConfig { XMonad.modMask = modm } =
  M.fromList
    ...
    --
    -- , ((modm              , xK_b     ), sendMessage D.ToggleStruts )
       , ((modm, xK_b), spawn "tp xmobar")
       , ((modm, xK_o), spawn "t")
